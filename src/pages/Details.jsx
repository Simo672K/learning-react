      ...
      {character.loading ? (
        ...
        <>
          ...
          <div className="d-flex details-card">
            <div className="col">
              <img
                src={character.data.thumbnail.path + ".jpg"}
                alt={character.data.name + " image"}
              />
            </div>
            <div className="col">
              <h2 className="details-heading">{character.data.name}</h2>
              <h3 className="details-title">
                Character name: {character.data.name}
              </h3>
              <h5 className="details-title__sub">
                Last time modified: {character.data.modified}
              </h5>
